...
def stage_5(window,window_size,window_search,sampleRate,classifier_name,series_of_experiments,plot_mode,matlab,classifier,file_index,auto,model_create):
