...
def stage_2(window,window_size,sampleRate,classifier_name,series_of_experiments,mode):
    ...
    input_file_2, input_path_2, output_file_2, output_path_2 = get_paths(2, sampleRate, classifier_name, series_of_experiments, mode)
    fft_std_path = os.path.join(output_path_2, f'{series_of_experiments}fft_std{classifier_name}.csv')
    best_index_path = os.path.join('./results/pc_classification/fft_index', f'{series_of_experiments}best_fft_index{classifier_name}.json')
