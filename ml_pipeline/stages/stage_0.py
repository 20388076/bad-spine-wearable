...
def stage_0(window,window_size,sampleRate,classifier_name,series_of_experiments,plot_mode,mode):
    ...
    input_file_0, input_path_0, output_file_0, output_path_0, plot_path = get_paths(0, sampleRate, classifier_name, series_of_experiments, mode)
    ...
    if plot_mode == 1:
        ...
        if series_of_experiments == 1:
            ...
            for axis, axis_name in axis_labels.items():
                ...
                plot_path1 = os.path.join(plot_path, f'{series_of_experiments}series_experiment_{axis}_axis_plot.png')
            ...
            for exp_tag in experiment_nums:
                ...
                plot_name = f'{series_of_experiments}series_experiment_{exp_tag[-1]}_condition.png'
                plot_path2 = os.path.join(plot_path, plot_name)
