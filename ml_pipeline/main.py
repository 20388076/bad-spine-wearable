...
series_of_experiments = 1 # we have execute 2 different experiments so it's taking 1 or 2 as input values
# ------------------------------ Auto Runner Option ---------------------------
...
# ----------------------------- Dataset Scaler ---------------------------
scale = 0 # 0: no features scaler before classification; 1 feature scaler setted on before classification
# ----------------------------- Classifier Factory ----------------------------
...
if auto == 0: 
    ...
    for cl in range(n_classifiers):
        ...
        if stage == 0: 
            ...
            test_score, Data_tag = stage_5(window,window_size,window_search,sampleRate,classifier_name,series_of_experiments,plot_mode,matlab,classifier,file_index,auto,model_create,scale)
    ...
    if same_window and n_classifiers >= 2:
        ...
        for cl in range(1, n_classifiers):
            ...
            copy_outputs_between_classifiers(series_of_experiments,sampleRate, src_name, dst_name)
