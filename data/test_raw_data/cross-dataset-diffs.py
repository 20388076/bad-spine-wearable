...
X = pd.read_csv(os.path.join('./3_FEATS/9.71_Hz_sampling/DT/EXP/',"z_5_9.71DT_feat.csv"))
X_try = pd.read_csv(os.path.join('./3_FEATS/9.71_Hz_sampling/DT/TEST/','test_z_5_9.71DT_feat.csv'))
...
print("\n**** Mean and Std Differences Between X_data and TEST_X_data ****\n")
